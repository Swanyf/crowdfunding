<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="modal fade" id="promissionAddModal" tabindex="-1"
			...
			<div class="modal-body">
				<form role="form">
					<div class="form-group">
						<label>节点名称</label> <input id="nameInput" type="text"
							class="form-control" placeholder="请输入节点名称">
					</div>
					  <div id="permissionAddIconDiv">
					...
					<div>
                        <label for="urlInput">节点地址</label>
                        <input id="urlInput" type="text" class="form-control" placeholder="请输入节点地址">
                    </div>
                    <button type="button" id="permissionAddBtn" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                    <button type="reset" id="permissionResetBtn" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</form>
			</div>
		</div>
	</div>
